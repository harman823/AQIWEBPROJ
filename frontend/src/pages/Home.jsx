...
// Define Backend URL and Cities
const API_BASE_URL = "https://aqiwebproj.onrender.com/api";
// UPDATED CITY LIST FROM CSV
const CITIES = [
  "Ahmedabad",
  "Aizawl",
  "Amaravati",
...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-20 md:py-32 overflow-hidden bg-linear-to-br from-emerald-400 via-teal-500 to-cyan-600">
        {" "}
        {/* Correction: bg-linear-to-br */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-emerald-100 mb-10">
              Real-time AQI data and machine learning forecasts for major cities
              worldwide. Breathe easier, plan smarter.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Live AQI readings for key global cities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {" "}
            {/* Centered grid */}
            <CurrentAqiList cities={CITIES} /> {/* Pass CITIES down */}
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-emerald-50">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              See the predicted air quality for the next 7 days.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-5xl mx-auto">
            ...
            <PredictionChart cities={CITIES} /> {/* Pass CITIES down */}
          </div>
          <div className="text-center mt-8">
            <Link
              to="/predictions"
              className="text-emerald-600 hover:text-emerald-800 font-semibold group"
            >
      ...
      <section id="how-it-works" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Leveraging advanced machine learning for accurate AQI forecasting.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-emerald-50 rounded-2xl p-8 text-center border border-emerald-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                ...
                We gather real-time pollutant data, weather patterns, historical
                trends, and geographical information from diverse sources
                worldwide.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-2xl p-8 text-center border border-emerald-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Analyzes millions of data points, identifying complex patterns
                and relationships affecting air quality.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 rounded-2xl p-8 text-center border border-emerald-100 transition duration-300 hover:shadow-lg">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Receive clear 7-day AQI forecasts, empowering you to make
                informed decisions about your health and daily activities.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-linear-to-r from-emerald-500 to-teal-600">
        {" "}
        {/* Correction: bg-linear-to-r */}
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Ready to Breathe Smarter?
          </h2>
          <p className="text-xl text-emerald-100 mb-10 max-w-2xl mx-auto">
            Explore detailed air quality predictions for your city.
          </p>
          <Link
            to="/predictions"
            className="bg-white text-emerald-600 hover:bg-emerald-50 font-semibold py-3 px-8 rounded-full transition duration-300 shadow-lg transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-emerald-500"
